...
const char *topic_soil1 = "soil7";
const char *topic_soil2 = "soil8";
...
void aggg(){
    HTTPClient http;
        String url = "https://script.google.com/macros/s/AKfycbx8epk8-NIs751vmMJWxTk1z1fH17LN6obBdw__1KjgpT0yMj9VZk_NLeyCMWBQCpAU/exec?data7="+String(soil1)+"&data8="+String(soil2);
