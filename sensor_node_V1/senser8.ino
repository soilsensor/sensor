...
const char *topic_soil1 = "soil15";
const char *topic_soil2 = "soil16";
...
void aggg(){
    HTTPClient http;
        String url = "https://script.google.com/macros/s/AKfycbx8epk8-NIs751vmMJWxTk1z1fH17LN6obBdw__1KjgpT0yMj9VZk_NLeyCMWBQCpAU/exec?data15="+String(soil1)+"&data16="+String(soil2);
